  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // HARDENED FULL SCREEN ON MOBILE
        "inset-0 translate-x-0 translate-y-0 h-full max-w-none m-0 rounded-none sm:inset-auto sm:left-[50%] sm:top-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:w-full sm:max-w-lg sm:h-auto sm:rounded-2xl",
        className
      )}
      {...props}
    >
