    ...
    <div className="min-h-screen bg-white font-body flex flex-col items-center justify-center p-4">
      <main className="w-full max-w-sm space-y-10 py-12 bg-white">
        <div className="text-center space-y-3">
          ...
          <h1 className="text-2xl font-black uppercase text-secondary tracking-tight">Login</h1>
          <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.3em]">Business Directory</p>
        </div>
        ...
        <div className="text-center pt-6 border-t border-[#E5E5E1]">
          <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest">
            Need an account? <Link href="/signup" className="text-primary underline ml-1">Sign Up</Link>
          </p>
        </div>
      </main>
    </div>
